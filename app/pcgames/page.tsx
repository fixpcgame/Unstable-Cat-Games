...
export default async function PCGamesPage() {
  const videoUrls = await getResourcesFromFolder('PC Games/Fix PC/Videos', 'video');
  const imageUrls = await getResourcesFromFolder('PC Games/Fix PC/Images', 'image');
