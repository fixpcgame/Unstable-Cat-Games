      ...
      >
        ...
        <div className={`w-full px-6 sm:px-12 flex items-center justify-between relative z-20 transition-all duration-500 ease-in-out ${paddingClasses}`}>
          <Link href="/#home" className="flex items-center gap-3 sm:gap-5 group" onClick={() => { closeMobileMenu(); setActiveSection('home'); }}>
            <div className={`flex items-center gap-3 sm:gap-5 transition-all duration-500 ease-in-out transform ${isActive ? 'opacity-100 scale-100 translate-x-0' : 'opacity-0 scale-75 -translate-x-6 pointer-events-none'}`}>
              <div className="relative w-12 h-12 sm:w-16 sm:h-16 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3">
                <Image
                  src="/Assets/cat.png"
                  alt="Cat Icon"
                  fill
              ...
              <div className="relative w-32 h-10 sm:w-40 sm:h-12 transition-transform duration-500 group-hover:scale-105 group-hover:rotate-1">
                <Image
                  src="/logos/logo.png"
          ...
          <nav className={`hidden md:block transition-all duration-500 ease-in-out ${!isActive ? 'opacity-0 pointer-events-none translate-x-10' : 'opacity-100 translate-x-0'}`}>
            <ul className="flex items-center space-x-8 text-lg font-medium">
              <li>
                <Link href="/#home" onClick={() => setActiveSection('home')} className={`relative transition-all duration-300 hover:-translate-y-0.5 inline-block group ${isHomeActive ? 'text-white font-semibold' : 'text-white/80 hover:text-white'}`}>
                  Home
              ...
              <li>
                <Link href="/#fixpc-hero" onClick={() => setActiveSection('fixpc-hero')} className={`relative transition-all duration-300 hover:-translate-y-0.5 inline-block group ${isFixPcActive ? 'text-white font-semibold' : 'text-white/80 hover:text-white'}`}>
                  Fix PC
              ...
              <li>
                <Link href="/#rightthatsit-hero" onClick={() => setActiveSection('rightthatsit-hero')} className={`relative transition-all duration-300 hover:-translate-y-0.5 inline-block group ${isRightThatsItActive ? 'text-white font-semibold' : 'text-white/80 hover:text-white'}`}>
                  Right That's It
              ...
              <li>
                <Link href="/#mobilegames" onClick={() => setActiveSection('mobilegames')} className={`relative transition-all duration-300 hover:-translate-y-0.5 inline-block group ${isMobileGamesActive ? 'text-white font-semibold' : 'text-white/80 hover:text-white'}`}>
                  Mobile Games
              ...
              <li>
                <Link href="/contactme" className={`relative transition-all duration-300 hover:-translate-y-0.5 inline-block group ${isContactPage ? 'text-white font-semibold' : 'text-white/80 hover:text-white'}`}>
                  Contact
        ...
        <div className="flex items-center justify-between px-6 py-6 border-b border-white/10">
          <Link href="/#home" className="flex items-center gap-3" onClick={() => { closeMobileMenu(); setActiveSection('home'); }}>
            <div className="relative w-14 h-14">
              <Image src="/Assets/cat.png" alt="Cat Icon" fill className="object-contain" priority />
            </div>
            <div className="relative w-36 h-10 transform transition-transform duration-500 hover:scale-105">
              <Image src="/logos/logo.png" alt="Unstable Cat Games Logo" fill className="object-contain" priority />
            </div>
          </Link>
          <button className="p-2 text-white hover:text-[#E46362] transition-transform duration-500 hover:rotate-90 focus:outline-none" onClick={closeMobileMenu} aria-label="Close mobile menu">
