...
export default function Community() {
  return (
    <section className="relative w-full bg-gradient-to-b from-[#0e172a] via-[#0b1222] to-[#0e172a] flex flex-col z-10 pt-12 sm:pt-24 pb-12">
      <div className="w-full relative aspect-[3114/930] flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-12 w-full max-w-5xl">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-3 sm:mb-6 tracking-tight leading-tight text-white drop-shadow-xl">
            Join the{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5865F2] to-[#a3aef5] animate-pulse">
              Community
            </span>
          </h2>
          ...
          <a 
            ...
            className="group/btn relative px-5 py-2.5 sm:px-8 sm:py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold rounded-full transition-all duration-300 shadow-[0_10px_35px_rgba(88,101,242,0.45)] hover:shadow-[0_20px_50px_rgba(88,101,242,0.7)] hover:-translate-y-1 z-20 flex items-center gap-3 text-sm sm:text-lg"
          >
