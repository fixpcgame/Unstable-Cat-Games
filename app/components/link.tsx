...
export default function LinkGame({ imageUrls }: LinkGameProps) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative">
        ...
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] sm:w-[110%] h-[80%] sm:h-[90%] bg-[#1be88b] rounded-[3rem] sm:rounded-[4rem] -rotate-6 group-hover:-rotate-12 group-hover:scale-105 transition-all duration-700 ease-out z-0 shadow-2xl"></div>
        ...
        >
          <div className="relative">
            <div className="inline-block px-5 py-2 rounded-full bg-gradient-to-r from-[#1be88b] to-[#5effba] text-sm font-black tracking-widest text-white uppercase w-fit shadow-md mb-6">
              Out Now
            </div>
            
            <h2 className="text-6xl sm:text-7xl font-black leading-none mb-6 text-gray-900 tracking-tight">
              <span className="text-[#1be88b]">Link</span>
            </h2>
            
            <p className="text-xl text-gray-600 font-medium leading-relaxed mb-8 border-l-4 border-[#1be88b] pl-6">
              Let the light guide you: a minimalist puzzle game focused on calm thinking for those quiet moments. Embrace your inner builder - tinker with mirrors, glass and beams in the built-in level editor!
            </p>

            <div className="flex flex-wrap gap-4 mb-10">
              <button className="px-8 py-4 bg-[#1be88b] text-white font-bold rounded-full shadow-[0_10px_20px_rgba(27,232,139,0.3)] hover:shadow-[0_15px_30px_rgba(27,232,139,0.5)] hover:-translate-y-1 transition-all duration-300">
                Get it on iOS
              </button>
                      ...
                      return (
                        <button
                          ...
                          className={`relative w-16 sm:w-20 aspect-[9/19.5] rounded-xl overflow-hidden flex-shrink-0 transition-all duration-300 snap-center ${
                            isActive
                              ? 'ring-4 ring-[#1be88b] scale-105 shadow-md z-10 mx-1'
